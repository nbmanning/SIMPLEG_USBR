...
# export as csv
#write.csv(loss.dt, "../US_Drought_Shock_v3/colsom_2012/colsom12_FIPS.csv")
library(dpylr)
loss.dt <- loss.dt %>%
...
# save raster
## r = Loss Rate 
save(r, file = "../Data_Derived/shock_v3_r99.RData")
...
# save
ggsave("../Figures/SIMPLEG_Shock_v3.png",
       height = 10, width = 15, dpi = 300)

# (6) shock for SIMPLE-G global  ----
xygID  <- rast("../US_Drought_Shock_v3/grid_id_xyg.tif")
plot(xygID)

nGrid = 1316744

# resample our loss raster to the grid cells of SIMPLE-G
