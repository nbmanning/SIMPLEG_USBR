...
# v4:
# -- calculate the insurance indemnity payments from only drought and heat per insured acre (A = Loss/Acre)
## -- note: the difference here is that we filter to drought+heat, corn+soybeans, and months of drought (may-october)
